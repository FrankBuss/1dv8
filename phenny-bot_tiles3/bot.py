...
class Phenny(irc.Bot):
	...
	def input(self, origin, line, text, bytes, match, event, args):
	...
	def dispatch(self, origin, line, args):
			...
			for regexp, funcs in items:
				for func in funcs:
					...
					if match:
						...
						input = self.input(origin, line, text, bytes, match, event, args)
